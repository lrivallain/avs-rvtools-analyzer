...
- **Server-Side Configuration**: Secure environment variable configuration eliminates client-side credential handling
- **Automatic Detection**: Service automatically detects environment configuration and enables AI functionality
- **AI-Powered Suggestions**: Click "AI Suggestion" on any risk card to receive intelligent migration recommendations
- **Always-Visible Disclaimer**: Prominent warning about AI-generated content when functionality is available
- **Direct HTML Output**: AI generates structured HTML content with proper formatting
