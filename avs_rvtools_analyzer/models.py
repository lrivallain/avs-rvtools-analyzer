...
class AISuggestionResponse(BaseModel):
    ...
    tokens_used: Optional[int] = Field(None, description="Number of tokens used in the AI request")
    input_tokens: Optional[int] = Field(None, description="Number of input tokens used in the AI request")
    output_tokens: Optional[int] = Field(None, description="Number of output tokens generated by the AI")
    carbon_footprint: Optional[float] = Field(None, description="Carbon footprint estimation data")
